...
import 'package:chatroomapp/presentation/pages/mobile/widget/mobile_message_layout.dart';
import 'package:chatroomapp/presentation/pages/widget/message_layout.dart';
...
class SingleChatPageMobile extends StatefulWidget {
  ...
  const SingleChatPageMobile({Key? key, required this.uid, required this.userName}) : super(key: key);
        ...
        child: ListView.builder(
          ...
          itemBuilder: (_, index) {
            return messages.messages[index].senderId ==
              ...
              boxMainAxisAlignment: MainAxisAlignment.start, uid: '',
            );
          },
        ),
      ),
